...
public class RestBoardController {
	...
	// @PathVariable : URL 경로에 있는 값을 파라미터로 추출할 때 사용
	@GetMapping("/shop/{id}/{product}") // 경로변수
	...
	@GetMapping("/{bid}/{bname}/{btitle}") // 경로변수
...
//	@PostMapping("/")
//	public String writ(@RequestBody BoardVO board) {
//		log.info("write..");
...
//	}
	...
	@PostMapping("/")
	public ResponseEntity<String> writ(@RequestBody BoardVO board) {
